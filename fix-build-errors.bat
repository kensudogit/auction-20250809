@echo off
echo ========================================
echo Nuxt.js Build Error Fix Script
echo ========================================
...
echo.
echo 2. Cleaning all build artifacts and dependencies...
cd frontend
...
echo   - Removing .nuxt directory (if exists)...
if exist .nuxt rmdir /s /q .nuxt 2>nul

echo   - Removing .output directory (if exists)...
if exist .output rmdir /s /q .output 2>nul
