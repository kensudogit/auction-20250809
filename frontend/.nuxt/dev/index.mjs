...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file://C:/dev2508/auction/frontend/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/dev2508/auction/frontend/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/dev2508/auction/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://C:/dev2508/auction/frontend/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/dev2508/auction/frontend/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/dev2508/auction/frontend/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/dev2508/auction/frontend/node_modules/defu/dist/defu.mjs';
...
import { createFetch, Headers as Headers$1 } from 'file://C:/dev2508/auction/frontend/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/dev2508/auction/frontend/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/dev2508/auction/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/dev2508/auction/frontend/node_modules/unstorage/drivers/fs.mjs';
...
import { dirname as dirname$1, resolve as resolve$1 } from 'file://C:/dev2508/auction/frontend/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/dev2508/auction/frontend/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/dev2508/auction/frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/dev2508/auction/frontend","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/dev2508/auction/frontend/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/dev2508/auction/frontend/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/dev2508/auction/frontend/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/dev2508/auction/frontend/.data/kv"}));
...
const _084gstC5IucQA5Q6os284VT9tuUaX0AtNia7Fy3PU = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/dev2508/auction/frontend";
...
const _PHo1Eec6LvnW9i29SwwZRSNZ32D9gOSsqKugfv6HkM = (nitroApp) => {
...
const plugins = [
  _084gstC5IucQA5Q6os284VT9tuUaX0AtNia7Fy3PU,
_PHo1Eec6LvnW9i29SwwZRSNZ32D9gOSsqKugfv6HkM
];
...
const _9M_yu4 = eventHandler((event) => {
...
const getServerEntry = () => import('file://C:/dev2508/auction/frontend/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://C:/dev2508/auction/frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_lptzke = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _9M_yu4, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_lptzke, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_lptzke, lazy: true, middleware: false, method: undefined }
];
